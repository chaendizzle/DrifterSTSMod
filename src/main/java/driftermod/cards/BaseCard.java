...
import driftermod.util.CardStats;
import driftermod.util.TriFunction;
...
import static driftermod.util.GeneralUtils.removePrefix;
import static driftermod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return DrifterMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    DrifterMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
